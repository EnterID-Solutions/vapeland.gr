      ...
      <?php } ?>
        ...
        <div class="col-md-4">
          <select name="option_format[]" class="colBindSelectize" multiple="multiple">
            ...
            <?php }} ?>
            <?php foreach (array('type', 'name', 'value', 'price', 'price_prefix', 'image', 'required', 'quantity', 'subtract', 'weight', 'points', 'sku', 'upc') as $opt_name) { if (!in_array($opt_name, isset($profile['option_format']) ? $profile['option_format'] : array())) { ?>
